...
3\. The artifact. Only after Lane confirms the prose is done. A fresh, wooden-but-readable translation from the Hebrew; creative, intentional glosses are encouraged. The goal is understanding, not conformity to traditional renderings. Follow joshua\_study\_style\_reference.md and run its checklist before saving.



Three standing moves during pass 2. None are optional, and all three exist because the alternative is an observation that never becomes an action:
...
Surgical edits to project files over wholesale rewrites. Confirm scope before building each deliverable. Ask Lane rather than guess when design or scope is unclear — it is always cheaper than guessing.The study
