...
| ḥesed | חָ֑סֶד (Josh 2:12) | **left untranslated ("ḥesed"), with a gloss** | Locked 2026-09-21 (Lane). Two occurrences, both Rahab (2:12): "I have done ḥesed with you... you also will do ḥesed with my father's house" — a reciprocal covenant-loyalty exchange, paired with "a sign of truth" and sworn by Yahweh, not the word's more common divine-to-human register. "Steadfast love" reads oddly for a spy-protection pact; "kindness" (WEB's choice) loses the obligation entirely; "loyalty" is the closest single word but still thinner than the term carries. Same pattern as `torah` (already transliterated, already a thread) — the word stays "ḥesed" in running prose, glossed at first occurrence rather than forced into one lossy English word. |
